...
This library initially started as a fork of [codegreencreative/laravel-samlidp](https://github.com/codegreencreative/laravel-samlidp) but it is now being changed significantly. In the future, these credits might be removed when at least 80% of the codebase is changed to the best of our knowledge.
